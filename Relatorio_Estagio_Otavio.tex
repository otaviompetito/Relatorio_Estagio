...
\section{Ramo de atividades}
	...
	Eletrificação, automação e digitalização são os campos de crescimento de longo prazo da Siemens. Para aproveitar totalmente o potencial de mercado nesses campos, os negócios são agrupados em nove divisões, além dos serviços de saúde, que constituem um negócio gerenciado separadamente.\textsuperscript{[2]}
...
\section{Desenvolvimento do software de simulação SIMIT com o simulador de campo SIMBA Profibus}
	...
	Realizadas as importações, é necessário criar os 'típicos', que são os modelos que para os elementos de campo, ou seja, válvulas \textit{on/off}, válvulas proporcionais, motores, entre outros.
